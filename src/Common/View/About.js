...
const About = () => {
    return (
        ...
        <div ClassName="Content">
            ...
            container spacing={2}>
                <Grid item xs={8}>
                    <p>Cookaholic là nơi chia sẻ các công thức nấu ăn để giúp bạn nấu các bữa ăn ngon với ít căng thẳng và nhiều niềm vui hơn. 
                    ...
                    <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        <Grid item xs={6}>
                            ...
                            <p>Nhóm sinh viên thực hiện đến từ trường Đại học Sư Phạm Kĩ Thuật Tp.HCM</p>   
                        </Grid>
                        <Grid item xs={6}>
                            <a className="titleQ">
                                Kitchen
